...
app.use('/api', require('./routes/parametros.route'));
app.use('/api', require('./routes/generos.route'));
app.use('/api', require('./routes/autor.route'));
app.use('/api', require('./routes/libro.route'));
app.use('/api', require('./routes/descuentos.route'));
app.use('/api', require('./routes/usuarios.route'));
app.use('/api', require('./routes/puntos.route'));
app.use('/api', require('./routes/socio.route'));